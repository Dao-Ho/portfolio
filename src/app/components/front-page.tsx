        ...
        <div className="flex flex-col h-[85vh] bg-transparent w-[100vw] px-[20vw] text-foreground">
            <div className="h-full w-full mt-40 flex flex-col">
                <motion.div className="leading-[3vh]" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
                    ...
                    <h1 className="font-playfairDisplay text-[18px] ">I'm a Software Engineer passionate about building the future.</h1>
                    <h1 className="font-playfairDisplay text-[18px] ">Northeastern '27, Computer Science and Finance.</h1>
    ...
    <div className="flex flex-col h-[85vh] bg-transparent w-[100vw] text-foreground justify-center items-center ">
        <div className="flex-1 flex flex-row items-center h-full w-full justify-center items-center">
            <div className="flex-1 w-[55vw] flex flex-col font-roboto mx-[1.75vw] mt-[15vh] items-center">
                ...
                <motion.div initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.3, delay: 0.1 }}>
                    <h1 className="font-black text-[17vw] leading-[15vh]">I'm Dao Ho</h1>
                </motion.div>
                <motion.div initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.3, delay: 0.2 }}>
                    <h1 className="font-semibold text-[4.75vw] leading-[6vw]">Software Engineer, Developer, and Artist.</h1>
                </motion.div>
                <motion.div initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.3, delay: 0.3 }}>
        ...
        <div className="flex flex-2 w-[20vw] h-[20vh]">
            ...
            <motion.button initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.3, delay: 0.4 }}
                onClick={() => {
