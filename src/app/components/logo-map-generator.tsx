...
export const logoMap = ${JSON.stringify(config, null, 2)};`;
  ...
  const dotCount = config
    ? config.dotPositions.flat().filter((d) => d).length
    : 0;
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                className="w-4 h-4"
              />
              <label htmlFor="useImageColors" className={`text-sm font-light ${isLight ? "text-gray-900" : "text-gray-100"}`}>
        ...
        {config && (
          <div className="flex flex-col gap-4 p-6 rounded-lg border border-gray-300">
            <div className="flex flex-col gap-2">
              ...
              <div className={`text-sm font-light opacity-70 ${isLight ? "text-gray-800" : "text-gray-200"}`}>
                <p>Grid Size: {config.gridWidth} × {config.gridHeight}</p>
