        ...
        return (
            <a href="https://www.instagram.com/artdaoho/" target="_blank" rel="noopener noreferrer">
                <Image
                    ...
                    className={
                        isMobile
                            ? "transition ease-in-out delay-50 hover:scale-110 fill w-[4vw] h-[4vw]"
    ...
    return (
        <nav className="z-50 backdrop-blur bg-white/50 fixed w-full h-[10vh] shadow-xl flex justify-between">
            <div
                className={
                    isMobile
                        ? "inline-flex h-full w-1/2 px-5 items-center"
            ...
            >
                <a
                    ...
                    className={
                        isMobile
                            ? "flex h-full items-center text-[#212121] text-[4vw] font-bold font-bebas scroll-smooth focus:scroll-smooth active:scroll-smooth"
            ...
            <div className="flex pr-[3vw]">
                <div className="flex pr-[3vw] items-center h-full items-center">
                    <a
                        ...
                        className={
                            isMobile
                                ? "font-roboto text-[3vw] font-bold transition ease-in-out delay-50 hover:scale-110 cursor-pointer"
                ...
                <div className={isMobile ? "flex items-center h-full w-[5vw]" : "flex items-center h-full w-[3vw]"}>
                    {ig()}
                </div>
            </div>
        </nav>
