    ...
    const pfp = () => {
        return (
            <Image
                ...
                alt=""
                className={
                    isMobile ? "w-full h-auto max-h-[70vh] max-w-[95vw]" : " w-auto h-full max-h-[60vh] max-w-[40vw]"
                }
            />
        );
    };
                ...
                >
                    ...
                    <div className={isMobile ? "" : "float-right pr-[43vw]"}>
                        ...
                        >
                            ...
                            >
                                Dao Ho is an 21-year-old self-taught artist studying at Northeastern University. With a
                                focus on ink, he combines various mark-making techniques to emphasize values hidden in
