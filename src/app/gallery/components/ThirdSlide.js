...
export const Artworks = () => {
    ...
    function ImageCaption({ src, alt, title, caption, award, award2, award3 }) {
        ...
        return (
            <motion.div className="cursor-pointer inline-flex flex flex-col" onClick={handleImageClick}>
                <Image
                    src={src}
                    quality={1}
                    alt={alt}
                ...
                <h1
                    className={
                        isMobile ? "font-libre pt-[2.5vh] font-bold text-[3.5vw]" : "font-libre pt-[2.5vh] text-[2.5vh]"
                    }
                >
                    {title} <br />
                    {caption} <br />
