    ...
    return (
        <div className="box-border h-screen w-screen relative">
            <div className="relative">
                <div className={` ${isMobile ? "flex-row h-screen w-screen justify-center" : "h-screen w-screen"}`}>
                    <div
                        className={` ${isMobile ? "flex pt-[15vh] w-[100vw] justify-center" : "h-screen w-1/2 absolute items-center"}`}
                    >
                        <div className={` ${isMobile ? "h-full" : "flex-inline translate-y-[20vh]"}`}>
                            <motion.div
              ...
              ${isMobile ? "flex pt-[2vh] text-[5vw] justify-center" : "pt-5 pl-3  text-[2vw] "}`}
                                >
                                    &lt;Engineer + Artist/&gt;
                                </p>
                            </motion.div>
